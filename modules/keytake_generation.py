...
from .prompts.prompt_temp import instructions_keypoint
from modules.helper_module import Helper_Class

class KeyTakeAwaysGenrationAssistant(Helper_Class):
    ...
    def create_completion(self, message_text):
        ...
        system_message = f"Please answer the question using the provided input text '{input_text}'. Follow the instructions provided: {instructions_keypoint}."
